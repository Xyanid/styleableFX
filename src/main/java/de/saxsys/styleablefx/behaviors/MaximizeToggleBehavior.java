...
/**
 * This is a basic behavior to allow for {@link Node}s to toggle maximized and minimized of the window it resides in.
 *
 * @param <TNode> the type of the node this behavior will be applied to
 *
 * @author Xyanid on 23.10.2015.
 */
public class MaximizeToggleBehavior<TNode extends Node> extends StageBehavior<TNode> {
     ...
     */
    public MaximizeToggleBehavior(final String methodName) {
        super(methodName);
    }

    //endregion

    //region Override StageBehavior
